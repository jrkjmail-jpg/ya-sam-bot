...
Отдельные AI-картинки шагов полностью выключены в коде: бот делает анализ и план через OpenAI, а карточки и коллаж собирает локально. Это сильно дешевле для MVP.
