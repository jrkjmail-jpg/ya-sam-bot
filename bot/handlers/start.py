...
START_TEXT = (
    ...
    "Пришлите одно или несколько фото предмета. "
    "Сначала я определю объект и попрошу подтвердить, что это он. "
    "Потом вы напишете, что хотите сделать, а я создам визуальную инструкцию."
)
