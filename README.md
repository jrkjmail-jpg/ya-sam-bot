...
5. Ответьте, что хотите сделать.
6. Если бот просит уточнение, отправьте текст или дополнительное фото.
7. Получите текстовые шаги, отдельные визуальные карточки и общий коллаж.
