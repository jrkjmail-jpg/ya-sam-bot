...
OpenAI-генерация отдельных картинок шагов полностью отключена в коде. Бот делает AI-анализ и план, а карточки и коллаж собирает локально кодом.
...
2. Отправьте `/start`.
3. Пришлите фото.
4. Если есть несколько ракурсов, отправьте их одним альбомом: бот анализирует их как один объект.
5. Подтвердите найденный объект или нажмите «Я не знаю».
6. Напишите цель: например, «как закрепить это».
7. Дождитесь анализа.
8. Если бот просит уточнение, пришлите фото сбоку или напишите модель.
9. Проверьте, что пришли текстовые шаги, карточки и итоговый коллаж.
